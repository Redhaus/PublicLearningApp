...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$store.dispatch("fetchInstructor");
...
<style lang="scss">
   ...
   /* }*/
    ...
    opacity: 0;
    transition: background-color 1s cubic-bezier(0.25, 0.8, 0.5, 1), opacity 1s cubic-bezier(0.25, 0.8, 0.5, 1);
}
