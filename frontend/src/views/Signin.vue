...
<!--            <button @click="logout">logout</button>-->
            <div class="row">
                <q-card  class="" style="width:400px;">
                    <q-card-section  style="background-image: linear-gradient(to right, #74ebd5 0%, #9face6 100%);">
                        <h4 class="text-h5 text-black q-my-md q-mx-md">Login</h4>
...
<!--                    </q-card-section>-->
                    <q-card-actions class="q-px-lg">
                        <q-btn @click.prevent="SigninData" unelevated size="lg" color="black" class="full-width text-white" label="Sign In"/>
                    </q-card-actions>
