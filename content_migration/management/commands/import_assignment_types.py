...
from assignments_types.models import AssignmentTypes
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with open(options["file"]) as import_file:
            ...
            assignments = csv.DictReader(import_file)
            ...
            for a in assignments:
                ...
                TOPICS = createBlock(a, 'topics', 'Topics')
                ...
                # IMPORT
                import_assignments = AssignmentTypes.objects.create(
                ...
                # TEST
                # import_assignments = AssignmentTypes(
                #
                #     category_type=a["category_type"],
                #     title=a["title"],
                #     feat=a["feat"],
                ...
                print('ASSIGNMENTS: ', import_assignments)
                print('TITLE: ', a["feat"])
                #
                # # Import orderable
                #
...
# $ python manage.py import_assignment_types --file=".data/Assignment_Types_ImportC.csv"
